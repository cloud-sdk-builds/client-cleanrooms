...
[`@aws-sdk/client-cleanrooms`](https://www.npmjs.com/package/@aws-sdk/client-cleanrooms/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ErH2Yia97KjACtptrR0PiDjgtMZiB4r2ckf5EbA0lBWXEmalf3daOdSBQLOzMCcM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cleanrooms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.433.0/index.min.mjs": "sha384-ErH2Yia97KjACtptrR0PiDjgtMZiB4r2ckf5EbA0lBWXEmalf3daOdSBQLOzMCcM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cleanrooms/blob/refs/tags/3.433.0/LICENSE
```
