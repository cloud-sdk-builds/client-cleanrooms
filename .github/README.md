...
[`@aws-sdk/client-cleanrooms`](https://www.npmjs.com/package/@aws-sdk/client-cleanrooms/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bmxiANQvxBFnBLKnmOMM+s82TiF/TmPudc0H3DoGSKzeVcP1sbEF0dLagUTL2Hww
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cleanrooms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.858.0/index.min.mjs": "sha384-bmxiANQvxBFnBLKnmOMM+s82TiF/TmPudc0H3DoGSKzeVcP1sbEF0dLagUTL2Hww"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cleanrooms/blob/refs/tags/3.858.0/LICENSE
```
