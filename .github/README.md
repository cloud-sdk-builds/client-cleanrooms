...
[`@aws-sdk/client-cleanrooms`](https://www.npmjs.com/package/@aws-sdk/client-cleanrooms/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TwuiP0RCneVn+oouQgjKz63ASHMzw1m1B198nIihef3UgI1BtUgtG3tERJ9bXSup
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cleanrooms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.901.0/index.min.mjs": "sha384-TwuiP0RCneVn+oouQgjKz63ASHMzw1m1B198nIihef3UgI1BtUgtG3tERJ9bXSup"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cleanrooms/blob/refs/tags/3.901.0/LICENSE
```
