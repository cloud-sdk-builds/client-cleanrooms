...
[`@aws-sdk/client-cleanrooms`](https://www.npmjs.com/package/@aws-sdk/client-cleanrooms/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-onhKH0fLoORWhJMK7fw/3Lr2/BkjhwIeNgPjb0QBjGZCVCplUBepQAYD/CmFkusE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cleanrooms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cleanrooms@3.290.0/index.min.mjs": "sha384-onhKH0fLoORWhJMK7fw/3Lr2/BkjhwIeNgPjb0QBjGZCVCplUBepQAYD/CmFkusE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cleanrooms/blob/refs/tags/3.290.0/LICENSE
```
